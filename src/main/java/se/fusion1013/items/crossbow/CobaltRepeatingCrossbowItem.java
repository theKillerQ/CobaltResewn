...
public class CobaltRepeatingCrossbowItem extends CobaltCrossbowItem{
    public CobaltRepeatingCrossbowItem(CobaltItemConfiguration configuration, Settings settings) {
