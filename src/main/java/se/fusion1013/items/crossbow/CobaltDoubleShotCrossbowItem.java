...
public class CobaltDoubleShotCrossbowItem extends CobaltCrossbowItem{

    public CobaltDoubleShotCrossbowItem(CobaltItemConfiguration configuration, Settings settings) {
    ...
    private static boolean loadProjectile(LivingEntity shooter, ItemStack crossbow, ItemStack projectile, boolean simulated, boolean creative) {
        if (projectile.isEmpty()) {
            ...
            boolean isCreativeArrow = creative && projectile.getItem() instanceof ArrowItem;
            ItemStack itemStack;
            if (!isCreativeArrow && !creative && !simulated) {
    ...
    private static void shoot(World world, LivingEntity shooter, Hand hand, ItemStack crossbow, ItemStack projectile, float soundPitch, boolean creative, float speed, float divergence, float simulated) {
        if (!world.isClient) {
            ...
            if (shooter instanceof CrossbowUser) {
                ...
                ((ProjectileEntity)projectileEntity).setVelocity(vector3f.x(), vector3f.y(), vector3f.z(), speed, divergence);
            }
